...
const blueprint = JSON.parse(
  fs.readFileSync(
    path.resolve(__dirname, "../../onchain/blueprint.json"),
    "utf-8"
  )
);
const { compiledCode: sttScript, hash: policyId } = blueprint.validators.find(
...
| VS Code        | –         | Erweiterungen: _Dev Containers_, _Aiken Syntax_          |
